public class t1 {
    public static void main(String[] args) {
        ...
        System.out.println("Это число больше: " + ternaryEvaluation(8, 4));
        System.out.println("Это число больше: " + ternaryEvaluation(1, 11));
        System.out.println("Это число больше: " + ternaryEvaluation(5, 9) + "\n");
    ...
    public static int fitCalc(int minutes, int intensivnost) {
        int calories_v_min;
        switch (intensivnost) {
            case 1:
                calories_v_min = 1;
    ...
    public static int ticketSaler(int nomer_bileta, int stoimost_bileta) {
        double komissiya = 0.28 * nomer_bileta * stoimost_bileta;
        double obshaya_vyruchka = nomer_bileta * stoimost_bileta - komissiya;
